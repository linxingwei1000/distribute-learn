...
public class ConsumerTwo {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //交换机名
        //路由key，在广播模式下，该值不用填
        channel.queueBind(CommonConnect.EXCHANGE_QUEUE_TWO, CommonConnect.EXCHANGE_WEATHER_ROUTING, "zj.wenzhou.0215");
        channel.queueBind(CommonConnect.EXCHANGE_QUEUE_TWO, CommonConnect.EXCHANGE_WEATHER_ROUTING, "zj.ruian.0215");
        channel.basicQos(1);
